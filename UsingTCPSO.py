...
def optimize_features_tcpsao(features):
    # Placeholder for TCPSAO optimization logic
    optimized_features = features  # Replace with actual TCPSAO logic
...
def process_dataset(data_dir):
    ...
    for label in os.listdir(data_dir):
        ...
        for image_file in os.listdir(class_dir):
            ...
            optimized_features = optimize_features_tcpsao(features)
